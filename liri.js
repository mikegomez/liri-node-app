...
function parseCommand(command, arg) {
	...
	default:
		console.log("I'm sorry, there seems to be an error?");
		break;
...
function spotifySong(song) {
	...
	spotify.search({ type: 'track', query: "track:" + song, limit: 10 })
...
function movieInfo(movie) {
	...
	var queryUrl = "https://www.omdbapi.com/?apikey=trilogy&s=" + movie; // using search because sometimes just getting a movie by name gives strange results
